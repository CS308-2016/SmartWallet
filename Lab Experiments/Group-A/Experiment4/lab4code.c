 ...
 * Filename: lab4code.c
 * Functions: intTimer(),  TimerInt0Handler(), UARTIntHandler()
 * Global Variables: ui32ADC0Value[4], ui32TempAvg, ui32TempValueC, ui32TempValueF, i, j, t1,t2,st1,st2, mode, setTemp, flag, temp, co, arr[10]
 *
 */
...
void Timer0IntHandler(void)
{
	...
	if(mode==0)//Monitor
	{
		...
		while(temp!=0)
		{
			...
			arr[co]=temp%10+'0';
			//UARTCharPut(UART0_BASE, temp%10+'0');
			temp/=10;
			co++;
		}
		co--;
...
* Input: None
* Output: None
* Logic: Interrupt handler for UART. Reads characters from UART.
* Example Call: Automatically called on interrupt
*
*/
